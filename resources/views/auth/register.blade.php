            ...
            <div class="mt-4">
                ...
                <div class="mt-2">
                    <label class="inline-flex items-center">
                        <input type="radio" name="role" value="customer" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" checked>
                        <span class="ml-2 text-sm text-gray-600">{{ __('Customer') }}</span>
                    </label>
                    <label class="inline-flex items-center ml-6">
                        <input type="radio" name="role" value="seller" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500">
